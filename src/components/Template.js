...
import formImage from "../assets/frame.png"
...
const Template=({title,desc1,desc2,image,formType,setIsLoggedIn}) =>{
        ...
        return (
            <div className='flex justify-between w-11/12 max-w-max py-12 mx-auto gap-x-12 gap-y-0'>
                <div className='w-11/12 max-w-[450px]'>
                    ...
                    <p className='text-[1.125rem] leading-[1.675rem] mt-4'>
                        ...
                        <br/><span className='text-blue-100 italic'>{desc2}</span>
                    </p>
